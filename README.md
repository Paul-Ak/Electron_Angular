# Changes I have made
I wanted to run an Angular2 app in Electron so I have made the following changes to the Angular2-quickstart-master.
Added electron folder with 2 files, main.js and package.json, to src folder.
Added .angular-cli.json file top level folder.
Added polyfills.ts file to the src folder
Added two scripts, build-electron and start-electron, to package.json
Added @angular/cli and @angular/compiler-cli to devDependencies in package.json

Install the npm packages described in the `package.json` and verify that App works as Angular:
...
```
Copy the two files in the electron folder to the dist folder
Start electron app:
```shell
